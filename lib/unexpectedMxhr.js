...
module.exports = {
    ...
    installInto: function (expect) {
        ...
        expect
            .exportAssertion('<any> with xhr mocked out <object|array> <assertion>', function (expect, subject, requestDescriptions) {
                    ...
                    mockedXhr.onCreate = function (xhr) {
                        ...
                        setTimeout(function () {
                            ...
                            if (!isValidSendCall(xhr, sendPayload)) {
                                __lastError = new Error('unexpected-mxhr: GET requests do not support a payload to send().');
                            ...
                            var mockXhrPromise = expect.promise(function () {
